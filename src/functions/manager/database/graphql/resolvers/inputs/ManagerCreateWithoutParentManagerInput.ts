...
import { TransactionCreateNestedManyWithoutResponsibleManagerInput } from "../inputs/TransactionCreateNestedManyWithoutResponsibleManagerInput";
...
export class ManagerCreateWithoutParentManagerInput {
  ...
  @TypeGraphQL.Field(_type => TransactionCreateNestedManyWithoutResponsibleManagerInput, {
    nullable: true
  })
  transaction?: TransactionCreateNestedManyWithoutResponsibleManagerInput | undefined;
