...
import { UserUpdateOneRequiredWithoutCommandsInput } from "../inputs/UserUpdateOneRequiredWithoutCommandsInput";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class CommandUpdateInput {
  ...
  @TypeGraphQL.Field(_type => UserUpdateOneRequiredWithoutCommandsInput, {
    nullable: true
  })
  owner?: UserUpdateOneRequiredWithoutCommandsInput | undefined;
}
