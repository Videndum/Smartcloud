...
import { TransactionUpdateManyWithoutResponsibleManagerInput } from "../inputs/TransactionUpdateManyWithoutResponsibleManagerInput";
import { UserUpdateOneRequiredWithoutManagerInput } from "../inputs/UserUpdateOneRequiredWithoutManagerInput";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class ManagerUpdateWithoutParentManagerInput {
  ...
  @TypeGraphQL.Field(_type => TransactionUpdateManyWithoutResponsibleManagerInput, {
    nullable: true
  })
  transaction?: TransactionUpdateManyWithoutResponsibleManagerInput | undefined;
