...
import { TwitchUserCreateNestedOneWithoutUserInput } from "../inputs/TwitchUserCreateNestedOneWithoutUserInput";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class UserCreateWithoutTwitterUserInput {
  ...
  @TypeGraphQL.Field(_type => TwitchUserCreateNestedOneWithoutUserInput, {
    nullable: true
  })
  twitch?: TwitchUserCreateNestedOneWithoutUserInput | undefined;
}
