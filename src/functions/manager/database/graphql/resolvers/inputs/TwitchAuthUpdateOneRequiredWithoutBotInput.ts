...
import { TwitchAuthUpsertWithoutBotInput } from "../inputs/TwitchAuthUpsertWithoutBotInput";
import { TwitchAuthWhereUniqueInput } from "../inputs/TwitchAuthWhereUniqueInput";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class TwitchAuthUpdateOneRequiredWithoutBotInput {
  ...
  @TypeGraphQL.Field(_type => TwitchAuthUpsertWithoutBotInput, {
    nullable: true
  })
  upsert?: TwitchAuthUpsertWithoutBotInput | undefined;
  ...
  update?: TwitchAuthUpdateWithoutBotInput | undefined;
}
