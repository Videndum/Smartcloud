...
export declare function generateGraphQLScalarImport(sourceFile: SourceFile): void;
export declare function generatePrismaJsonTypeImport(sourceFile: SourceFile, options: GenerateCodeOptions, level?: number): void;
