...
export declare function mapScalarToTSType(scalar: string, isInputType: boolean): "string" | "number" | "boolean" | "Date" | "Prisma.InputJsonValue" | "Prisma.JsonValue";
export declare function getTypeGraphQLType(typeInfo: DMMF.TypeInfo, dmmfDocument: DmmfDocument, modelName?: string, typeName?: string): string;
export declare function mapScalarToTypeGraphQLType(scalar: string): string;
